    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="./"><img src="assets/img/logo.png" width="80px" height="80px"></a></h1>
                    </div>
                </div>
                    ...
                    <div class="shopping-item">
                        <a href="<?php echo site_url('Cart');?>">Cart - <span class="cart-amunt">
                            ...
                            foreach ($cart as $c)
                             ...
                             ?>
                             <?php 
                                            $fee=3+($total_amount*0.02);
                                            $tax=$fee*0.15;
                                            $subtotal=$fee+$tax+$total_amount;
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="single-sidebar">
                      ...
                      <!--  <?php echo form_open('searchProduct');?>
                        <?php
                        $data = array(
                                            'type'          => 'text',
                ...
                <div class="col-md-8">
                    <div class="product-content-right">
                        <div class="woocommerce">
                            ...
                            <?php $checkoutreturn=1; ?>

                            <?php $attributes = array('class' => 'checkout', 'name' => 'checkout','enctype'=>'multipart/form-data'); ?>
                            

                            

                            <?php echo form_open('beforePayment', $attributes);?> 
                                        ...
                                        <tbody>
                                            <tr class="cart_item">
                                                <td class="product-name">
                                                    Total Items: <strong class="product-quantity"><?php echo $total_items; ?></strong> </td>
                                                <td class="product-total">
                                                    <span class="amount">$<?php echo $total_amount; ?></span> </td>
                                            </tr>
                                        </tbody>

                                        <?php 
                                            if(isset($_SESSION['coupon_discount'])){
                                            $total_amount= $total_amount-$_SESSION['coupon_discount']; 
                                        }
                                        else{
                                        ...
                                        <tfoot>
                                            ...
                                            <tr class="cart-subtotal">
                                                ...
                                                <td><span class="amount">
                                                    ...
                                                    $<?php 
                                            if(isset($_SESSION['coupon_discount'])){
                                            echo $total_amount." <b>(coupon applied)</b>"; 
                                        }
                                        else{
                                           echo $total_amount; 
                                        }
                                            ...
                                            <tr class="shipping">
                                                ...
                                                <td>
                                                    ...
                                                    $<?php echo $fee+$tax; ?>
                                                    <input type="hidden" class="shipping_method" value="" id="shipping_method_0" data-index="0" name="shipping_method[0]">
                                                </td>
                                            </tr>
                                    ...
                                    <div id="payment">
                                        <ul class="payment_methods methods">
                                            ...
                                            <li class="payment_method_paypal">
                                             ...
                                             <li class="payment_method_cheque">
                                                <input type="radio" data-order_button_text="" value="instamojo" checked="checked" name="payment_method" class="input-radio" id="payment_method_cod">
                                                <label for="payment_method_cod">Pay via Debit/Credit card/NetBanking </label>
                                                <div style="display:none;" class="payment_box payment_method_cheque">
                                                    <p>Please send your cheque to Store Name, Store Street, Store Town, Store State / County, Store Postcode.</p>
                                                </div>
                                            </li>
                                             <li class="payment_method_cheque">
                                                ...
                                                <label for="payment_method_cod">COD(Cash on Delivery) </label>
                                                <div style="display:none;" class="payment_box payment_method_cheque">
                                                    <p>Please send your cheque to Store Name, Store Street, Store Town, Store State / County, Store Postcode.</p>
                                                </div>
                                            </li>
