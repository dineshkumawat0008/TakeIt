                    ...
                    <div class="single-sidebar">
                        ...
                        <h2 class="sidebar-title">Products</h2>
                         <div class="thubmnail-recent">
                            <img src="assets/img/<?php echo $s->product_image; ?>" class="recent-thumb" alt="">
                            <h2><a href="#"><?php echo $s->product_name; ?></a></h2>
                            <div class="product-sidebar-price">
                                <ins>$<?php echo $s->ins_price; ?></ins> <del>$<?php echo $s->del_price; ?></del>
                            </div>                             
                        </div>
                        <?php }
                        ...
                        <div class="woocommerce">
                                ...
                                <table cellspacing="0" class="shop_table cart">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="cart_item">
                                            <td class="product-remove">
                                                <a title="Remove this item" class="remove" href="<?php echo base_url()?>deleteItem/delete?deleteid=<?php echo $c->unique_id; ?>">×</a> 
                                            </td>

                                            <td class="product-thumbnail">
                                                <a href="#"><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="assets/img/<?php echo $c->product_image; ?>"></a>
                                            </td>
                                            ...
                                            <td class="product-price">
                                                <span class="amount"><?php echo $c->row_amount; ?></span> 
                                            </td>

                                            <td class="product-quantity">
                                                <div class="quantity buttons_added">
                                                    
                                                    <?php echo form_open(base_url('updateItem/update/'.$c->unique_id));?>
                                            <?php 
                                    $data = array(
                                            'type'          => 'number',
                                            'size'            => '4',
                                   ...
                                   ?>
                                            ...
                                            <td class="product-subtotal">
                                                <span class="amount">$<?php echo $c->total_amount; ?></span> 
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td class="actions" colspan="6">
                                                <div class="coupon">
                                                    <?php echo form_open('coupon/discount');?>
                            ...
                            foreach ($cart as $c)
                             ...
                             ?>
                                                ...
                                                <a href="<?php echo base_url()?>Checkout"><input type="submit" value="Checkout" name="proceed" class="checkout-button button alt wc-forward"></a>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
