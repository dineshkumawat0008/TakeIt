                ...
                <div id="container_demo" >
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                        	<font style="color:red;"><i><?php if(isset($_SESSION['returncheckout'])){ echo "Before Payment please login first";} ?></i></font></br>
                        	
                             <?php echo form_open(base_url('login/user_login'));?>
                                <h1>Log in</h1> 
                                <p> 
                                	<font style="color:red;"><i><?php if(isset($error)){ echo $error;} ?></i></font></br>
                                ...
                                <p class="change_link">
									Not registered?
									<?php echo anchor('registrationController/registration_manager', 'Join Us', 'class="to_register"');?>
								</p>
                            </form>
                        </div>
